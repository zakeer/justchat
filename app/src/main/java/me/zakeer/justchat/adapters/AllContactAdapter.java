...
import me.zakeer.justchat.AddContactFriend;
...
public class AllContactAdapter extends BaseAdapter {
	...
	public AllContactAdapter(Context context, List<FriendItem> list) {
						...
						asyncLoadVolley.setOnAsyncTaskListener(new OnAsyncTaskListener() {
							...
							public void onTaskComplete(boolean isComplete, String message) {
								...
								if(asyncResponse.ifSuccess()) {
									...
									String contact_list = ((AddContactFriend)context).getcontactno();
									((AddContactFriend)context).getresponse(contact_list);
